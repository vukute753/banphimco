<div class="add_product">
    ...
    <form enctype="multipart/form-data" method="post">
        ...
        <div class="in_text">
            ...
            <div>
                ...
                <input type="text" name="soluong" id="soluong" pattern="[0-9]*" title="Vui lòng nhập đúng định dạng số lượng" required><br>
            </div>
            <div class="form-gr">
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "INSERT INTO sanpham (tensanpham, gia, hinhanh, mota, loai, soluong) 
        VALUES ('$tensanpham', $gia, '$hinhanh', '$mota', $loai, $soluong);";
